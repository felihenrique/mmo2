...
func handleChans(server gsp.IServer, peers *map[string]gsp.IPeer, peersLock *sync.Mutex) {
...
func readEvents(server gsp.IServer, peers *map[string]gsp.IPeer, peersLock *sync.Mutex) {
